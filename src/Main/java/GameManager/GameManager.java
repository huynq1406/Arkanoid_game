...
//        if (!ball.isLaunched())
    ...
    private void checkCollisionWithBricks() {
        ...
        List<ExplosiveBrick> triggeredExplosives = new ArrayList<>();
        ...
        for (AbstractBrick brick : bricks) {
            ...
            if (brick instanceof ExplosiveBrick) {
                triggeredExplosives.add((ExplosiveBrick) brick);
            }
        }

        for (ExplosiveBrick explosiveBrick : triggeredExplosives) {
        explosiveBrick.explode(bricks);
    }
    }
